    ...
    <div className="relative w-full h-screen overflow-hidden">
      <div className="relative z-20 flex h-screen w-full items-center justify-center px-6 text-center">
        <div className="container mx-auto flex flex-col items-center gap-12 text-center">
          <div data-aos="fade-down" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium" style={{ background: 'rgba(46,139,87,0.08)', border: '1px solid rgba(46,139,87,0.15)', color: '#2E8B57' }}>
            AI-Powered Startup Collaboration Platform
          </div>

          <h1 data-aos="zoom-in" data-aos-delay="100" className="text-5xl md:text-7xl max-w-4xl tracking-tighter font-bold">
          ...
          <p data-aos="fade-up" data-aos-delay="200" className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl mx-auto text-center mt-4">
          ...
          <div data-aos="fade-up" data-aos-delay="300" className="flex flex-col sm:flex-row gap-4 mt-8 justify-center">
